  ...
  <div class="container-fluid">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
        <textarea name="address" class="form-control" id="customeraddress" placeholder="Customer Address" cols="40" rows="3" required><?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?></textarea>
        </div>
      </div>
