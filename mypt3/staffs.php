  ...
  <div class="row">
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
        <input name="email" type="text" class="form-control" id="staffemail" placeholder="Staff Email Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>" required>
        </div>
      </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a174807_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
