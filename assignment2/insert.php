...
if (isset($_POST['add_form'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("INSERT INTO myguestbookassg (user, email, find, front, form, interface, postdate, posttime, comment) VALUES (:user, :email, :find, :front, :form, :interface, :pdate, :ptime, :comment)");
