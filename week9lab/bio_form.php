...
<input type="range" name="height" id="heightId" min = "100" max = "200" oninput="outputId.value = heightId.value"  style="width: 20%;">
...
<input type="color" name="color" id="idcolor" style="width: 20%;"><br>
