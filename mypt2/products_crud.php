...
if (isset($_POST['update'])) {
  ...
  try {
      ...
      $stmt = $conn->prepare("UPDATE tbl_products_a174807_pt2 SET fld_product_num = :pid, fld_product_name = :name, fld_product_price = :price, fld_product_brand = :brand, fld_product_volume = :volume, fld_product_type = :type , fld_product_category = :category, fld_product_description = :description, fld_product_stock = :stock WHERE fld_product_num = :oldpid");
