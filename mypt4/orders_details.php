...
<style type="text/css">
      .btn-aml {
      background-color: #3a235b !important;
...
<body style="background-image: url('images/Background 2.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a174807, tbl_staffs_a174807_pt4,
          tbl_customers_a174807_pt2 WHERE
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-9">
      ...
      <button class="btn btn-aml2" type="submit" name="addproduct"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      <a href="invoice.php?oid=<?php echo $_GET['oid']; ?>" target="_blank" role="button" class="btn btn-aml btn-lg btn-block">Generate Invoice</a>
    </div>
  </div>
  <br>
</div>
