...
<div class="container-fluid dark" style="padding-bottom: 30px;">
    <div class="row">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input name="address" type="text" class="form-control" id="customeraddress" placeholder="Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?>" required>
        </div>
      </div>
                    ...
                    <div class="col-sm-offset-3 col-sm-9">
                        <?php if (isset($_GET['edit'])) { ?>
                            <input type="hidden" name="oldcid"
                                   value="<?php echo $editrow['fld_customer_num']; ?>">
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <table class="table table-striped table-bordered">
                ...
                try {
                    ...
                    $stmt = $conn->prepare("select * from tbl_customers_a174807_pt2 LIMIT {$start_from}, {$per_page}");
                    $stmt->execute();
