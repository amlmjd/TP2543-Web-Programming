...
$univ = array
  ...
  'sex' => "female",
  'address' => "Alor Setar",
  'email' => "a174807@siswa.ukm.edu.my",
  'dob' => "2000-10-13",
  'height' => 166,
  'phone' => "+6018-4734516",
  'color' => "#390080",
  'fbtwig' => " https://www.facebook.com/amal.majida",
  'univ' => "UKM",
  'matricnum' => "a174807"
  );
...
<form action="validate_biodata.php" method="post">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>Sex:</td>
      <td>
        <input type="radio" name="sex" value="male" <?php if($record['sex'] == "male"); ?>>Male<br>
...
<hr>
<input type="hidden" name="matricnum" value="a174807">
