...
if (isset($_POST['biodata_form'])) {
  ...
  {
    $msg .= "Error: Please insert telephone no.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert social media.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please select University.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert matric num.<br>";
    $count_error++;
  }
